		...
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				...
				if strings.Contains(inText,"subscribe")||strings.Contains(inText,"-s"){
					...
					if _, err = bot.ReplyMessage(event.ReplyToken, linebot.NewImageMessage("image","https://raw.githubusercontent.com/emily830518/BOTTEST/master/images/help.png")).Do(); err != nil {
						log.Print(err)
					}
